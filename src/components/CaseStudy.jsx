  ...
  return (
    <section className='bg-white p-5 md:p-10'>
        <div className='bg-slate-50 rounded-lg flex flex-col leading-6 py-8 px-5 md:flex-row gap-6'>
            ...
            {/* Session Details */}
            <div>
                <h1 className='text-2xl font-semibold py-2 md:-mt-5'>Why Businesses Loves Cimplii</h1>
                ...
                <div className='mx-auto text-center md:text-left'>
                    <button className="bg-black w-full text-white px-15 py-2 text-[15px] hover:bg-slate-300 hover:text-black md:w-auto">▪ Read the study</button>
                </div>
            </div>
        </div>
    </section>
